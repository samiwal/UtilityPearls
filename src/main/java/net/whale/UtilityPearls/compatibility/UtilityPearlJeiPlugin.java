...
public class UtilityPearlJeiPlugin implements IModPlugin {
    ...
    public void registerRecipes(IRecipeRegistration registration) {
        ISubtypeManager subtypeManager = new SubtypeManager(new SubtypeInterpreters());
        StackHelper stackHelper = new StackHelper(subtypeManager);

        registration.addRecipes(RecipeTypes.CRAFTING, UtilityPearlHitEntityRecipeMaker.createRecipes(stackHelper));
        registration.addRecipes(RecipeTypes.CRAFTING, UtilityPearlOwnerRecipeMaker.createRecipes(stackHelper));
    }
